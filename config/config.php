...
const DB_USER_DEFAULT = 'jotavsevla';
const DB_PASS_DEFAULT = 'sapinho12';
const APP_NAME_DEFAULT = 'Água Mineral VIVA';

// Variáveis que serão utilizadas na aplicação (inicializadas com valores padrão)
...
if (file_exists(__DIR__ . '/../.env')) {
    ...
    foreach ($lines as $line) {
        ...
        // Atualiza variáveis específicas
        switch ($name) {
            case 'DB_HOST':
                $DB_HOST = $value;
                break;
