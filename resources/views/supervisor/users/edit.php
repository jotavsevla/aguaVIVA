...
<head>
    <meta charset="UTF-8">
    <title>Editar Usuário - Água Mineral VIVA</title>
...
<body>
<div class="header">
    <h1>Editar Usuário - Água Mineral VIVA</h1>
    <div class="user-info">
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Edição de Usuário</h2>
        </div>
        <div class="card-body">
            <form method="post" action="/supervisor/users/update/<?php echo $user['id']; ?>">
