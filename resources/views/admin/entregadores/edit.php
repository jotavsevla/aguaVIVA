...
$formData = $_SESSION['form_data'] ?? $entregador;
...
<head>
    <meta charset="UTF-8">
    <title>Editar Entregador - Agua Mineral VIVA</title>
    ...
    <style>
        ...
        .status-em_entrega { background-color: #fff3cd; color: #856404; }
        .status-indisponivel { background-color: #f8d7da; color: #721c24; }
    </style>
</head>
<body>
<div class="header">
...
<div class="container">
    ...
    <div class="form-card">
        <h2 class="form-title">
            Editar: <?php echo htmlspecialchars($entregador['nome']); ?>
            <span class="status-badge status-<?php echo $entregador['status']; ?>">
                <?php
                $statusLabels = [
                ...
                echo $statusLabels[$entregador['status']] ?? $entregador['status'];
                ?>
            </span>
        </h2>
        <form method="post" action="/admin/entregadores/update/<?php echo $entregador['id']; ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="veiculo" name="veiculo" value="<?php echo htmlspecialchars($formData['veiculo'] ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label for="placa">Placa</label>
                    <input type="text" id="placa" name="placa" value="<?php echo htmlspecialchars($formData['placa'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" required>
                    ...
                    <option value="em_entrega" <?php echo ($formData['status'] ?? '') === 'em_entrega' ? 'selected' : ''; ?>>Em Entrega</option>
